...
func (in *ClusteragentSpec) DeepCopyInto(out *ClusteragentSpec) {
	*out = *in
	...
	if in.NSRules != nil {
		in, out := &in.NSRules, &out.NSRules
		*out = make([]NSRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NSRule) DeepCopyInto(out *NSRule) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NSRule.
func (in *NSRule) DeepCopy() *NSRule {
	if in == nil {
		return nil
	}
	out := new(NSRule)
